        ...
        <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.3 }} viewport={{ once: true }} className='text-gray-700 dark:text-gray-400'>
          ...
          <div className='items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0'>
            <div className='flex gap-2 text-sm'>
              <input className='w-full p-3 text-sm font-semibold outline-none rounded-lg border border-gray-300 dark:border-gray-600' placeholder='Enter your email' type='email' id='email' required />
              <button type='submit' className='bg-primary text-white rounded px-6 cursor-pointer'>
                Subscribe
              </button>
            </div>
          </div>
